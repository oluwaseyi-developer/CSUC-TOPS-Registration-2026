  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'mesh-gradient': 'linear-gradient(135deg, #400a1a 0%, #6b1d35 25%, #8d2041 50%, #6b1d35 75%, #400a1a 100%)',
      },
      animation: {
      ...
      boxShadow: {
        ...
        'glow-primary': '0 0 30px rgba(107, 29, 53, 0.4)',
